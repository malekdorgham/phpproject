...
<head>
  ...
  <title>Add Department | Company Admin</title>
...
<div class="container">
  ...
  <div class="page-header d-flex justify-content-between align-items-center mb-4">
    <div>
      <h2 class="fw-bold"><i class="bi bi-plus-circle me-2"></i>Add Department</h2>
        ...
        <div class="card-body p-4">
          <form action="" method="post" class="form-container">
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
              ...
              if ($conn->query($sql) === TRUE) {
                echo '<div class="alert alert-success mb-4" role="alert">
                        <i class="bi bi-check-circle me-2"></i>Department added successfully!
                      </div>';
              } else {
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Enter the name of the new department</div>
            </div>
