...
<head>
  ...
  <title>Departments | Company Admin</title>
...
<main>
  <div class="container">
    ...
    <div class="page-header d-flex justify-content-between align-items-center mb-4">
      <div>
        <h2 class="fw-bold"><i class="bi bi-diagram-3 me-2"></i>Departments</h2>
      ...
      <div class="card-body p-0">
        <table class="table table-striped table-hover mb-0">
          ...
          if ($res->num_rows > 0) {
            ...
            echo "<tr><td colspan='3' class='text-center py-4'>No departments found. <a href='create.php'>Add one</a>!</td></tr>";
          }
          ?>
          </tbody>
        </table>
